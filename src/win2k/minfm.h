/*****************************************************************************
 * minfm.h - FM synth miniport private definitions
 *****************************************************************************
...
typedef struct _voiceStructOpl3 {
...
private:
    ...
    PADAPTERCOMMON  m_pAdapterCommon;       // Adapter
...
//  expand constructor to take bool for whether to include volume
    CMiniportMidiFM(PUNKNOWN pUnknownOuter)
...
private:
    ...
    // midi stuff
    voiceStructOpl3 m_Voice[NUM2VOICES];  /* info on what voice is where */
    ...
    VOID Opl3_NoteOff (BYTE bPatch,BYTE bNote, BYTE bChannel);
